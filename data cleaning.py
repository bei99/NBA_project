...
'''
 To do:
    ...
    - Pair from team's home stats and away stats (from MATCHUP create Home and Away)
...
# difference of Home vs Away, to just keep one stat row per match (HOME stats - AWAY stats), It is a good idea?

#print(basic_clean.head())
...
# feature engineering? (rest dates, injuries, form,
# merge the odds